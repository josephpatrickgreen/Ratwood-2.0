...
/atom/movable/screen/lobby/button/migration
	name = "Migration"
	// screen_loc = "WEST:20,TOP:-134" // original - moving up because lore button removed for now
	screen_loc = "WEST:20,TOP:-101"
...
/atom/movable/screen/lobby/button/actors
	name = "Actors"
	// screen_loc = "WEST:20,TOP:-167" // original - moving up because lore button removed for now
