...
#define isfey(A) (is_species(A, /datum/species/fey))
#define isredcap(A) (is_species(A, /datum/species/fey/redcap))
#define isgnome(A) (is_species(A, /datum/species/fey/gnome))
